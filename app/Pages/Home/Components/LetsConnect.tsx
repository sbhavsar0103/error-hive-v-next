...
const LetsConnect: React.FC = () => {
  return (
    <section
      // className="relative bg-[#060010] py-20 px-4 sm:px-6 lg:px-8 text-center overflow-hidden"
      className="relative bg-[#060010] py-14 sm:py-20 px-5 sm:px-6 lg:px-8 text-center overflow-hidden"
    >
      <div
        // className="max-w-7xl mx-auto bg-amber-500 rounded-3xl py-16 px-8 sm:px-12 relative z-10 shadow-[0_0_40px_rgba(245,158,11,0.4)]"
      ...
      >
        ...
        <FadeContent delay={0.6}>
          <Link href="/contact" passHref>
            <button
              type="button"
              // className="px-10 py-4 bg-[#060010] text-white font-semibold text-lg rounded-full shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
