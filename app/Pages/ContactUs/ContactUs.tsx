              ...
              >
                ...
                <div className="relative space-y-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white/5 border border-amber-500/20 text-amber-50 focus:ring-2 focus:ring-amber-500/50"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          rows={5}
                          required
                          className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white/5 border border-amber-500/20 text-amber-50 focus:ring-2 focus:ring-amber-500/50 resize-none"
                    ...
                    <button
                      type="submit"
                      className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-white font-semibold flex items-center justify-center gap-2"
                    >
                      Send Message
