...
interface BusinessSoftwareConsultingStepListItemProps {
  text: string;
}

export default function BusinessSoftwareConsultingStepListItem({
  text,
}: BusinessSoftwareConsultingStepListItemProps) {
  return (
