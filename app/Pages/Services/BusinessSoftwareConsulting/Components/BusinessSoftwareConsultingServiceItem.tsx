...
interface BusinessSoftwareConsultingServiceItemProps {
  service: BusinessSoftwareConsultingService;
  isSelected: boolean;
  onClick: () => void;
}

export default function BusinessSoftwareConsultingServiceItem({
  service,
  isSelected,
  onClick,
}: BusinessSoftwareConsultingServiceItemProps) {
