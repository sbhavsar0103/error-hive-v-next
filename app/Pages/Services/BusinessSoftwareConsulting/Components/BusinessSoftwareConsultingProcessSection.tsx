      ...
      >
        ...
        <div className="space-y-8 lg:sticky lg:top-[15rem] self-start">
          ...
          <div className="space-y-6">
            <h2 className="font-bold text-white leading-[1.1] tracking-tight" style={{ fontSize: "clamp(1.8rem, 5vw, 3.5rem)" }}
            >
              Our Business Software Consulting Process
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-md" style={{ fontSize: "clamp(0.9rem, 2.6vw, 1.1rem)" }}>
