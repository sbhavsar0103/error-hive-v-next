...
interface AnnotationServiceDetailsProps {
  selectedService: AnnotationService;
}

const AnnotationServiceDetails: React.FC<AnnotationServiceDetailsProps> = ({
  selectedService,
}) => {
...
export default AnnotationServiceDetails;
