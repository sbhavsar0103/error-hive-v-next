...
m font-medium tracking-wider uppercase px-4 py-2 rounded-full border border-amber-500/20 bg-amber-500/5 inline-block">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm sm:text-base sm:text-base lg:text-lg leading-relaxed max-w-md">
          ...
          <Link
            href="/contact"
            className="group relative inline-flex px-5 py-2.5 sm:px-8 sm:py-4 text-sm sm:text-base sm:text-base rounded-lg sm:rounded-xl bg-gradient-to-r from-amber-500 to-amber-600  text-white font-medium overflow-hidden  transition-all duration-300  hover:shadow-lg hover:shadow-amber-500/30 hover:scale-105">
      ...
      <div className="relative max-w-7xl mx-auto mt-32">
        <div className="relative bg-gradient-to-r from-amber-600/20 via-amber-500/15 to-amber-600/20 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-amber-500/20 overflow-hidden group hover:border-amber-500/40 transition-all duration-500">
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-gray-300 text-xs sm:text-sm px-3 py-1.5 sm:px-4 sm:py-2 leading-relaxed">
              ...
              <Link
                href="/contact"
                className="group/btn relative inline-flex px-5 py-2.5 sm:px-8 sm:py-4 text-sm sm:text-base rounded-lg sm:rounded-xl bg-white text-amber-600 font-semibold rounded-xl  overflow-hidden transition-all duration-300  hover:shadow-xl hover:shadow-amber-500/20 hover:scale-105 w-fit">
                <span className="relative z-10 flex items-center gap-2">
            ...
            <div className="relative h-80 flex items-center justify-center">
              ...
              <div className="relative w-full h-full bg-gradient-to-br from-amber-400/10 to-orange-400/5 rounded-2xl border border-amber-500/20 flex items-center justify-center overflow-hidden group/icon">
                ...
                <div className="relative text-4xl sm:text-6xl animate-pulse">
