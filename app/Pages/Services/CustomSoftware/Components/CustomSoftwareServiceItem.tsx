...
/** Service type */
export interface CustomSoftwareService {
  id: number;
  title: string;
  icon: LucideIcon;
}

interface CustomSoftwareServiceItemProps {
  service: CustomSoftwareService;
  isSelected: boolean;
  onClick: () => void;
}

const CustomSoftwareServiceItem: React.FC<CustomSoftwareServiceItemProps> = ({
  service,
  isSelected,
  onClick,
}) => {
...
export default CustomSoftwareServiceItem;
