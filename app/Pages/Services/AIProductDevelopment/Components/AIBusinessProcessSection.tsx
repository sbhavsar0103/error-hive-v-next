        ...
        <div className="space-y-8 lg:sticky lg:top-[15rem] self-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-md text-justify">
              Developing AI-powered products demands a disciplined and
              business-aligned methodology. As a bespoke AI application
              development company, our structured framework ensures operational
              efficiency, dependable performance, and sustainable growth.
            </p>
          </div>
        ...
        <div className="relative bg-gradient-to-r from-amber-600/20 via-amber-500/15 to-amber-600/20 backdrop-blur-xl rounded-3xl p-12 lg:p-6 border border-amber-500/20 overflow-hidden group hover:border-amber-500/40 transition-all duration-500">
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-80 flex items-center justify-center">
              ...
              <div className="relative w-full h-full bg-gradient-to-br from-amber-400/10 to-orange-400/5 rounded-2xl border border-amber-500/20 flex items-center justify-center overflow-hidden">
