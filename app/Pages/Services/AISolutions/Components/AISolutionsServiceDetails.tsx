...
interface AISolutionsServiceDetailsService {
  id: number;
  title: string;
  description: string;
  icon: LucideIcon;
...
interface AISolutionsServiceDetailsProps {
  selectedService: AISolutionsServiceDetailsService;
}

export default function BusinessSoftwareConsultingServiceDetails({
  selectedService,
}: AISolutionsServiceDetailsProps) {
