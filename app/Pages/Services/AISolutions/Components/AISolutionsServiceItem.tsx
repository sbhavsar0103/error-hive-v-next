...
interface AISolutionsServiceItemService {
  id: number;
  title: string;
  description: string;
  icon: LucideIcon;
...
interface AISolutionsServiceItemProps {
  service: AISolutionsServiceItemService;
  isSelected: boolean;
  onClick: () => void;
}

export default function AISolutionsServiceItem({
  service,
  isSelected,
  onClick,
}: AISolutionsServiceItemProps) {
