...
import AISolutionsServiceHeader from "./AISolutionsServiceHeader";
import AISolutionsServicesList from "./AISolutionsServicesList";
import AISolutionsServiceDetails from "./AISolutionsServiceDetails";
import services from "./AISolutionsServicesMenu";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 lg:h-[600px]">
          ...
          <div className="hidden lg:block">
            <AISolutionsServiceDetails selectedService={selectedService} />
          </div>
            ...
            <div className="flex transition-transform duration-700 ease-in-out" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
              {services.map((service) => (
                <div key={service.id} className="w-full flex-shrink-0 px-2">
                  <AISolutionsServiceDetails selectedService={service} />
                </div>
              ))}
            </div>
