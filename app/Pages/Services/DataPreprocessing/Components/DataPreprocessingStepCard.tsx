...
import GenerativeAIStepListItem from "./DataPreprocessingStepListItem";

interface DataPreprocessingStepCardProps {
  number: number;
  title: string;
  items: string[];
  delay: number;
...
const DataPreprocessingStepCard: React.FC<DataPreprocessingStepCardProps> = ({
  number,
  title,
  items,
  delay,
...
export default DataPreprocessingStepCard;
