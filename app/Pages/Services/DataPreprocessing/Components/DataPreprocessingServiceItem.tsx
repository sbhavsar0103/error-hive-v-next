...
interface DataPreprocessingServiceItem {
  id: number;
  title: string;
  icon: LucideIcon;
}

interface DataPreprocessingServiceItemProps {
  service: DataPreprocessingServiceItem;
  isSelected: boolean;
  onClick: () => void;
}

export default function DataPreprocessingServiceItem({
  service,
  isSelected,
  onClick,
}: DataPreprocessingServiceItemProps) {
