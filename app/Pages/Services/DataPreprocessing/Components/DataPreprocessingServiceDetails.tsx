...
interface DataPreprocessingServiceDetails {
  title: string;
  description: string;
  icon: LucideIcon;
}

interface DataPreprocessingServiceDetailsProps {
  selectedService: DataPreprocessingServiceDetails;
}

export default function DataPreprocessingServiceDetails({
  selectedService,
}: DataPreprocessingServiceDetailsProps) {
