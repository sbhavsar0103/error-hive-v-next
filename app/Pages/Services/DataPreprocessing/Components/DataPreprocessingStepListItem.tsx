...
interface DataPreprocessingStepListItemProps {
  text: string;
}

const DataPreprocessingStepListItem: React.FC<DataPreprocessingStepListItemProps> = ({
  text,
}) => {
  return (
...
export default DataPreprocessingStepListItem;
