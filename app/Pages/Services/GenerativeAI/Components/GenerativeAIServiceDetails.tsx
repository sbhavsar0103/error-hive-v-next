...
interface GenerativeAIServiceDetailsProps {
  selectedService: GenerativeAIService;
}

export default function GenerativeAIServiceDetails({
  selectedService,
}: GenerativeAIServiceDetailsProps) {
