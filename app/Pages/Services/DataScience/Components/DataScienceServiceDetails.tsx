...
interface DataScienceServiceDetailsProps {
  selectedService: Service;
}

const DataScienceServiceDetails: React.FC<DataScienceServiceDetailsProps> = ({
  selectedService,
}) => {
...
export default DataScienceServiceDetails;
