...
interface MachineLearningServiceDetailsProps {
  selectedService: MachineLearningService;
}

export default function MachineLearningServiceDetails({
  selectedService,
}: MachineLearningServiceDetailsProps) {
