...
import UIUXDevelopmentServiceHeader from "./UIUXDevelopmentServiceHeader";
import UIUXDevelopmentServicesList from "./UIUXDevelopmentServicesList";
import UIUXDevelopmentServiceDetails from "./UIUXDevelopmentServiceDetails";
import services from "./UIUXDevelopmentMenu";
import { ChevronLeft, ChevronRight } from "lucide-react";

export default function UIUXDevelopmentServicesPage() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 lg:h-[600px]">
          ...
          <div className="hidden lg:block">
            <UIUXDevelopmentServiceDetails selectedService={selectedService} />
          </div>
            ...
            <div className="flex transition-transform duration-700 ease-in-out" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
              {services.map((service) => (
                <div key={service.id} className="w-full flex-shrink-0 px-2">
                  <UIUXDevelopmentServiceDetails selectedService={service} />
                </div>
              ))}
            </div>
