...
interface UIUXDevelopmentServiceItemService {
  id: number;
  title: string;
  description: string;
  icon: LucideIcon;
...
interface UIUXDevelopmentServiceItemProps {
  service: UIUXDevelopmentServiceItemService;
  isSelected: boolean;
  onClick: () => void;
}

export default function UIUXDevelopmentServiceItem({
  service,
  isSelected,
  onClick,
}: UIUXDevelopmentServiceItemProps) {
