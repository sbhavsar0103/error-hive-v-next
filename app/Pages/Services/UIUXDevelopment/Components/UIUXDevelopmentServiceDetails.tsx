...
interface UIUXDevelopmentServiceDetailsService {
  id: number;
  title: string;
  description: string;
  icon: LucideIcon;
...
interface UIUXDevelopmentServiceDetailsProps {
  selectedService: UIUXDevelopmentServiceDetailsService;
}

export default function UIUXDevelopmentServiceDetails({
  selectedService,
}: UIUXDevelopmentServiceDetailsProps) {
